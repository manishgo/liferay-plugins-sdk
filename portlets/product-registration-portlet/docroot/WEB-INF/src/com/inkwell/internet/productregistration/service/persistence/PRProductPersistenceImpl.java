		...
		if (isNew || !PRProductModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((prProductModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(prProductModelImpl.getOriginalGroupId()),
				...
				args = new Object[] {
						Long.valueOf(prProductModelImpl.getGroupId()),
			...
			if ((prProductModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(prProductModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(prProductModelImpl.getCompanyId())
					};
		...
		if (prProduct == null) {
			...
			try {
				...
				if (prProduct != null) {
					...
					EntityCacheUtil.putResult(PRProductModelImpl.ENTITY_CACHE_ENABLED,
						PRProductImpl.class, productId, _nullPRProduct);
				}
