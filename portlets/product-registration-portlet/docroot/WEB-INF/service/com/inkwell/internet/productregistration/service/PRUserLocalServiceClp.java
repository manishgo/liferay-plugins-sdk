...
public class PRUserLocalServiceClp implements PRUserLocalService {
	public PRUserLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addPRUserMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addPRUser",
				com.inkwell.internet.productregistration.model.PRUser.class);

		_createPRUserMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createPRUser", long.class);

		_deletePRUserMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deletePRUser", long.class);

		_deletePRUserMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deletePRUser",
				com.inkwell.internet.productregistration.model.PRUser.class);
		...
		_getPRUserMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPRUser", long.class);

		_getPRUsersMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPRUsers", int.class, int.class);

		_getPRUsersCountMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPRUsersCount");

		_updatePRUserMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"updatePRUser",
				com.inkwell.internet.productregistration.model.PRUser.class);

		_updatePRUserMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"updatePRUser",
				com.inkwell.internet.productregistration.model.PRUser.class,
				boolean.class);

		_addRegUserMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"addRegUser",
				com.inkwell.internet.productregistration.model.PRUser.class,
				long.class);

		_getRegUserMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
				"getRegUser", long.class, long.class);
	}
	...
	public com.inkwell.internet.productregistration.model.PRUser addRegUser(
		com.inkwell.internet.productregistration.model.PRUser user, long userId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_addRegUserMethodKey13,
				user, userId);
	...
	public com.inkwell.internet.productregistration.model.PRUser getRegUser(
		long groupId, long userId)
		throws com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_getRegUserMethodKey14,
				groupId, userId);
	...
	private MethodKey _addPRUserMethodKey0;
	private MethodKey _createPRUserMethodKey1;
	private MethodKey _deletePRUserMethodKey2;
	private MethodKey _deletePRUserMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _getPRUserMethodKey8;
	private MethodKey _getPRUsersMethodKey9;
	private MethodKey _getPRUsersCountMethodKey10;
	private MethodKey _updatePRUserMethodKey11;
	private MethodKey _updatePRUserMethodKey12;
	private MethodKey _addRegUserMethodKey13;
	private MethodKey _getRegUserMethodKey14;
}