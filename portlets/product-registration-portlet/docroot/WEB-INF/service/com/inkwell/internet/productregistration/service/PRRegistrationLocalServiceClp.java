...
public class PRRegistrationLocalServiceClp implements PRRegistrationLocalService {
	public PRRegistrationLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addPRRegistrationMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addPRRegistration",
				com.inkwell.internet.productregistration.model.PRRegistration.class);

		_createPRRegistrationMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createPRRegistration", long.class);

		_deletePRRegistrationMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deletePRRegistration", long.class);

		_deletePRRegistrationMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
		...
		_getPRRegistrationMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPRRegistration", long.class);

		_getPRRegistrationsMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPRRegistrations", int.class, int.class);

		_getPRRegistrationsCountMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPRRegistrationsCount");

		_updatePRRegistrationMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"updatePRRegistration",
				com.inkwell.internet.productregistration.model.PRRegistration.class);

		_updatePRRegistrationMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"updatePRRegistration",
				com.inkwell.internet.productregistration.model.PRRegistration.class,
				boolean.class);

		_addRegistrationMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"addRegistration",
				com.inkwell.internet.productregistration.model.PRRegistration.class);

		_getAllRegistrationsMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
	...
	private MethodKey _addPRRegistrationMethodKey0;
	private MethodKey _createPRRegistrationMethodKey1;
	private MethodKey _deletePRRegistrationMethodKey2;
	private MethodKey _deletePRRegistrationMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _getPRRegistrationMethodKey8;
	private MethodKey _getPRRegistrationsMethodKey9;
	private MethodKey _getPRRegistrationsCountMethodKey10;
	private MethodKey _updatePRRegistrationMethodKey11;
	private MethodKey _updatePRRegistrationMethodKey12;
	private MethodKey _addRegistrationMethodKey13;
	private MethodKey _getAllRegistrationsMethodKey14;
}