...
public class PRUserLocalServiceUtil {
	...
	*/
	public static com.inkwell.internet.productregistration.model.PRUser addRegUser(
		com.inkwell.internet.productregistration.model.PRUser user, long userId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().addRegUser(user, userId);
	}

	/**
	* Gets a RegUser object from a Liferay User primary key or null if
	* it wasn't found.
	*
	* @param groupId
	* @param userId
	...
	* @throws SystemException
	*/
	public static com.inkwell.internet.productregistration.model.PRUser getRegUser(
		long groupId, long userId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getRegUser(groupId, userId);
	}
	...
	public static PRUserLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					PRUserLocalService.class.getName(), portletClassLoader);
